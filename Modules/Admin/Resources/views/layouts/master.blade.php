          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('service.index')}}">
                <i class="nav-icon icon-list text-primary"></i> Services
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('team.index')}}">
                <i class="nav-icon icon-user text-primary"></i> Teams
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('category.index')}}">
                <i class="nav-icon icon-star text-success"></i> Categories
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('portfolio.index')}}">
                <i class="nav-icon icon-list text-success"></i> Portfolios
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('post.index')}}">
                <i class="nav-icon icon-star text-success"></i> Posts
              </a>
            </li>
            <li class="nav-item">
